  ...
  "inline-flex items-center rounded-full border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-800",
  {
    variants: {
      variant: {
        ...
        paid: "border-transparent bg-[#33D69F] text-zinc-900 hover:bg-[#33D69F]/80 dark:bg-[#33D69F] dark:text-zinc-900 dark:hover:bg-[#33D69F]/80",
        pending:
          "border-transparent bg-[#FF8F00] text-zinc-900 hover:bg-[#FF8F00]/80 dark:bg-[#FF8F00] dark:text-zinc-900 dark:hover:bg-[#FF8F00]/80",
      },
    },
    defaultVariants: {
      variant: "default",
